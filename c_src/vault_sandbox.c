 ...
 * vault_sandbox.c
 *
 * VAULT SECURITY SYSTEM — DiamondVault Hardened Sandbox v2
 * Section 12 from diamondVaults.c
 *
...
VaultError vault_sandbox_open(Vault *v, const char *password) {
    ...
    vault_log(LOG_AUDIT, "[SANDBOX] Starting DiamondVault Hardened Sandbox v2 "
